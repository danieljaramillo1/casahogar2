...
$routes->get('/animales/tipo/(:num)', 'Animal::buscarTipo/$1');



$routes->post('/producto/registro/nuevo', 'Producto::registrar');
$routes->post('/animal/registro/nuevo','Animal::registrarA');
